<template>
  ...
  <v-footer dark heigth="auto"></v-footer>  
  ...
  <script>
    ...
    export default {
      // async created() {
      //   this.categories = await axios.get('http://localhost:3000/categories')
      //   this.products = await axios.get('http://localhost:3000/categories')
